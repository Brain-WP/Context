 ...
 */
final class CommentsContextProvider implements ContextProviderInterface
{
    ...
    public function __construct(
        ...
        $this->key = is_string($key) && $key ? $key : 'comments';
    ...
    {
        return [$this->key => get_comments($this->queryArgs)];
    }
}
